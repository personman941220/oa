                            ...
                            <form name="f1" id="f1" action="?m=system&amp;c=myInfo&amp;a=updateInfo&amp;type=1" method="post">
                            	...
                            	<div id="form-left">                            		
	                                ...
	                                <div class="kv-item clearfix">
	                                    ...
	                                    <div class="kv-item-content">
	                                        <input name="employee.idCard" type="text" placeholder="请输入18位身份证号">
	                                    </div>
	                                </div>
	                                ...
	                                <div class="kv-item clearfix">
	                                    ...
	                                    <div class="kv-item-content">
	                                        <input name="employee.educational" type="text" placeholder="学历">
	                                    </div>
	                                </div>
	                                ...
	                                <div class="kv-item clearfix">
	                                    ...
	                                    <div class="kv-item-content time-select-wrap">
			                                <div class="time-select">
			                                    <input type="text" name="employee.hireDate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" placeholder="入职时间">
			                                    <i class="date-icon"></i>
			                                </div>			                                
                            			</div>
	                                </div>
								...
								<div id="form-rigth">		
	                                ...
	                                <div class="kv-item clearfix">
	                                    ...
	                                    <div class="kv-item-content time-select-wrap">
			                                <div class="time-select">
			                                    <input type="text" name="employee.birthday" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" placeholder="出生日期">
			                                    <i class="date-icon"></i>
			                                </div>			                                
                            			</div>
	                                </div>
	                                ...
	                                <div class="kv-item clearfix">
	                                    <label>政治面貌：</label>
	                                    <div class="kv-item-content">
	                                        <input name="employee.politicsStatus" type="text" placeholder="政治面貌">
	                                    </div>
	                                </div>
	                                ...
	                                <div class="kv-item clearfix">
	                                    ...
	                                    <div class="kv-item-content">	                                        
	                                     	 <div class="kv-item-content time-select-wrap">
				                                <div class="time-select">
				                                    <input type="text" name="employee.workDate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" placeholder="工作时间">
				                                    <i class="date-icon"></i>
				                                </div>			                                
                            				</div>
	                                    </div>
	                                ...
	                                <div class="kv-item clearfix">
	                                    ...
	                                    <div class="kv-item-content">	                                        
	                                     	 <div class="kv-item-content time-select-wrap">
				                                <div class="time-select">
				                                    <input type="text" name="employee.probationPeriod" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" placeholder="试用日期">
				                                    <i class="date-icon"></i>
				                                </div>			                                
                            				</div>
	                                    </div>
	                                ...
	                                <div class="kv-item clearfix">
	                                    ...
	                                    <div class="kv-item-content">	                                        
	                                     	 <div class="kv-item-content time-select-wrap">
				                                <div class="time-select">
				                                    <input type="text" name="employee.positivePhase" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" placeholder="转正日期">
				                                    <i class="date-icon"></i>
				                                </div>			                                
                            				</div>
	                                    </div>
	                                ...
	                                <div class="kv-item clearfix">
	                                    ...
	                                    <div class="kv-item-content">	                                        
	                                     	 <div class="kv-item-content time-select-wrap">
				                                <div class="time-select">
				                                    <input type="text" name="employee.graduationDate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" placeholder="毕业时间">
				                                    <i class="date-icon"></i>
				                                </div>			                                
                            				</div>
	                                    </div>
                                ...
                                <div id="form-button-left">
	                                <div class="kv-item clearfix">
	                                    <label>家庭关系：</label>
	                                    <div class="kv-item-content">
	                                        <textarea name="employee.familyRelationShips" placeholder="家庭关系"></textarea>
	                                    </div>
	                                </div>
