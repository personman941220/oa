...
public class Employee {
	...
	public String toString() {
		return "Employee [employeeId=" + employeeId + ", name=" + name + ", idCard=" + idCard + ", phone=" + phone
				+ ", address=" + address + ", lastJob=" + lastJob + ", nowJob=" + nowJob + ", nativePlace="
				+ nativePlace + ", educational=" + educational + ", departmentId=" + departmentId + ", hireDate="
				+ hireDate + ", email=" + email + ", sex=" + sex + ", nation=" + nation + ", birhtday=" + birhtday
				+ ", politicalStatus=" + politicalStatus + ", workDate=" + workDate + ", specialty=" + specialty
				+ ", familyRelationships=" + familyRelationships + ", socialRelations=" + socialRelations + ", resume="
				+ resume + ", remark=" + remark + ", probationPeriod=" + probationPeriod + ", positivePhase="
				+ positivePhase + ", graduationDate=" + graduationDate + ", status=" + status + "]";
	}
